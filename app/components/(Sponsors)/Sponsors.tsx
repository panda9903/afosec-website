...
{/*<Image
  ...
  />*/}
  <h4 className="text-4xl font-bold text-center mb-8">Platinum Sponsors</h4>
      ...
      <br></br><br></br><br></br>
      <h4 className="text-3xl font-bold text-center">Gold Sponsors</h4>
      <div className="flex flex-col md:flex-row justify-center items-center gap-8 mb-10">
        <div className="flex flex-col items-center">
          {/*
          <Image
      ...
      <br></br><br></br><br></br>
      <h4 className="text-2xl font-bold text-center">Silver Sponsors</h4>
