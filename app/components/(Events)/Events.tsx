...
const Events = () => {
  return (
    <section id="events">
      <h2 className="text-4xl font-bold text-center mt-20 mb-10">Central Events</h2>
  ...
  */}
        ...
        <div className="z-10 w-full md:w-auto">
          <h3 className="text-3xl font-bold text-center mb-5">Ideation & Project Expo</h3>
          <IdeationCarousel/>
        </div>
        <div className="z-10 w-full md:w-auto mt-10 md:mt-0">
          <h3 className="text-3xl font-bold text-center mb-5">Literary & Cultural Events</h3>
          <EventCarousel />
        </div>
      </div>
    </section>
