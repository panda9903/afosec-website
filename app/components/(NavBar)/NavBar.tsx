...
export default function Navbar() {
  ...
  const menus = [
    ...
    { title: "Register", path: "/register.php" },
  ];
  ...
  return (
    <nav
      className={`w-full md:border-0 px-6 sticky top-0 backdrop-blur-3xl backdrop-opacity-100 backdrop-filter drop-shadow z-50 ${
        visible ? "" : "hidden"
      }`}
    >
